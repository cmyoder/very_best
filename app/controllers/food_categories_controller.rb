class FoodCategoriesController < ApplicationController
  def index
    ...
    @food_categories = @q.result(:distinct => true).includes(:dish, :cousine).page(params[:page]).per(10)
  ...
  def create
    ...
    @food_category.cousine_id = params[:cousine_id]
    @food_category.dish_id = params[:dish_id]
